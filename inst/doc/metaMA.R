...
###################################################
### code chunk number 5: normalizedata
###################################################
...
###################################################
### code chunk number 9: Human Gene database
###################################################
...
###################################################
### code chunk number 12: totalconversion
###################################################
...
###################################################
### code chunk number 13: nb
###################################################
nb=length(rownames(esets[[1]]))


###################################################
### code chunk number 14: metama
###################################################
library(metaMA)
...
###################################################
### code chunk number 15: IDDIRR
###################################################
x=IDDIRR(res$Meta,res$AllIndStudies)


###################################################
### code chunk number 16: venndiagram
###################################################
library(VennDiagram)
...
###################################################
### code chunk number 17: annotationdb
###################################################
...
###################################################
### code chunk number 18: getannotationpackages
###################################################
source("http://bioconductor.org/biocLite.R")
biocLite(db1)
biocLite(db2)
...
###################################################
### code chunk number 19: getannotation
###################################################
